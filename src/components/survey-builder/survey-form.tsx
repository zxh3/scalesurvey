...
export function SurveyForm({
  ...
  const [questions, setQuestions] = useState<BaseQuestion[]>(initialData?.questions || []);
  const [allowLiveResults, setAllowLiveResults] = useState(initialData?.allowLiveResults || false);
