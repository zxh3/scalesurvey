...
export default function AdminDashboardPage() {
  ...
  const handleClose = async () => {
    ...
    if (!confirm("Are you sure you want to close this survey? It will stop accepting responses.")) {
      return;
    }
      ...
      <div className="container max-w-5xl mx-auto">
        ...
        <div className="grid gap-4 md:grid-cols-3 mb-6">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold capitalize">{survey.status}</div>
            </CardContent>
          </Card>
        </div>
        ...
        <Card className="mb-6">
          ...
          <CardContent>
            <div className="flex gap-2">
              ...
              <Button variant="outline" size="icon" onClick={() => window.open(surveyUrl, "_blank")}>
